...
const PAGE_GUIDES = [
  ...
  },
  {
    ...
    details: [
      ...
      'My activity: pings when someone else moves your WTB/WTS deal forward — not when you click it yourself',
      'Marketplace activity (opt-in): new WTB/WTS listings and board updates from other members',
      'Support: staff replies and ticket resolved notices on your tickets',
      'Up to four webhooks per account; pick different event sets per channel',
      'Requires sign-in — not available in Offline Mode',
    ],
