...
const PAGE_GUIDES = [
  ...
  },
  {
    ...
    description: 'Create and manage custom crafting orders for org members or customers.',
    details: [
      ...
      'Great for coordinating large crafting projects',
    ],
  ...
  },
  {
    ...
    details: [
      ...
      'Coordinate with order creators through the system',
    ],
        ...
        <div className="p-4 bg-gradient-to-br from-slate-800/60 to-slate-900/40 rounded-lg border border-orange-500/20 space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400 mt-1 leading-relaxed">
                <strong className="text-white">Dumper's Fair Price (DFP)</strong> is an algorithmic pricing 
