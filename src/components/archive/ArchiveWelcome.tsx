...
const PAGE_GUIDES = [
  ...
  },
  {
    ...
    description: 'Get Dumper\'s Repo updates sent directly to your Discord server.',
    details: [
      'Receive notifications when new orders are placed or fulfilled',
      'Get alerts when blueprint data is synced with the latest game updates',
      'Create a webhook in your Discord server settings',
      'Register your webhook on the subscribe page and select which events you want',
      'Notifications are one-way — your Discord receives updates automatically',
      'Anyone can subscribe their Discord channel, no account required',
    ],
    relatesTo: ['Custom Orders', 'Blueprints', 'General Archive'],
  },
]
