...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      ...
      'Ledger ore profit uses Purchased (Q0) DFP per 100 cSCU of yield with cSCU unrefined/yield columns; gems are sold as-is with a whole gem count (no refine or yield columns)',
      ...
      'Click a crew payout amount to copy the aUEC value to your clipboard',
  ...
  },
  {
    ...
    details: [
      ...
      'Seller-side WTS: start handoff, mark ready, and manage active sales including partial child orders',
  ...
  },
  {
    ...
    details: [
      ...
      'Set up from your avatar menu → Webhooks after sign-in — hidden in Ghost Mode',
    ],
