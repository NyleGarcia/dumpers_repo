...
export const PAGE_GUIDES: ArchivePageGuide[] = [
  ...
  },
  {
    ...
    details: [
      ...
      'Generate and copy your personal BP Dumper API key from Settings — this key works only with the BP Dumper program',
      'Regenerate your BP Dumper key from Settings if it is compromised',
